...
RUN pip install --no-cache-dir --timeout=3600 --retries=10 numpy opencv-python opencv-contrib-python
RUN pip install --no-cache-dir --timeout=3600 --retries=10 pybullet
